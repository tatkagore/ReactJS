...
const List = () => {
  ...
  return (
    <div>
      <TitleH1 name="Tanya" age={27} />
      <button onClick={() => handleColorFilter("Rouge")}>Rouge</button>
      <button onClick={() => handleColorFilter("Vert")}>Vert</button>
